...
import { entryFormSchema, type EntryFormData } from "./types";

function RateLimitCountdown({ nextTryTimestamp }: { nextTryTimestamp: number }) {
...
export default function QrCodePage() {
      ...
      try {
        ...
        if (result.error) {
          if (result.nextTryTimestamp) {
            ...
            url.searchParams.set('nextTryTimestamp', result.nextTryTimestamp.toString());
  ...
  if (error) {
    ...
    const nextTryTimestamp = isRateLimited ? parseInt(isRateLimited) : null;
